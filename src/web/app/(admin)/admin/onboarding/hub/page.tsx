    ...
    return (
        <Prose>
            ...
            <ul>
                ...
                <li>
                    <Mention>
                        <FaHashtag /> network-events
                    </Mention>{" "}
                    receives published items from HQ&apos;s{" "}
                    <Mention>
                        <FaBullhorn /> network-events
                    </Mention>
                    .
                </li>
                <li>
