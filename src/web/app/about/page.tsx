            ...
            <Prose>
                ...
                <Panel>
                    ...
                    <p>
                        ...
                        Mains-style fan communities. We place an emphasis on collaborative community-building, servers offering help and resources to each
                        other, and maintaining healthy and safe communities for Genshin Impact fans to find a home in on Discord.
                    </p>
                </Panel>
                <br />
                <Panel>
                    ...
                    <p>
                        The TCN does not enforce any particular structure on its member servers. TCN servers are not required to change their server setup,
                        follow a template, enforce particular rules, or give any permissions to TCN observers. Our only requirements are to display a list of
                        TCN partner servers, cross-post event promotions from partner servers, and maintain a healthy community that follows its rules.
                    </p>
                    <p>
                        The main component of the TCN is you &mdash; our community and our constituent servers. In addition, we have an official public server,
                        the{" "}
                        <a href={process.env.HUB_INVITE} className="link" target="_blank">
                            TCN Hub
                        </a>
                        , which we use for official communications and where you can contact us and other server staff and ask questions or give feedback about
                        the TCN. We also have a private HQ server for internal communication and organization.
                    </p>
                </Panel>
                <br />
                <Panel>
