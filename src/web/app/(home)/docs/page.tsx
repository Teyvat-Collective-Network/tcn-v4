    ...
    return (
        <LandingPage>
            <LandingPanel href="/docs/autosync">
                <h2>Autosync</h2>
                <p>
                    Autosync allows you to keep your server&apos;s TCN partner list automatically updated. This section documents its configuration settings and
                    additional commands.
                </p>
            </LandingPanel>
            ...
            <LandingPanel href="/docs/global-chat">
                <h2>Global Chat</h2>
                <p>
                    This section contains administrative information on operating global chat, information for appointed and general network moderators, and any
            ...
            <LandingPanel href="/docs/exit-procedure">
                ...
                <p>
                    Sometimes servers choose to leave the network or things don&apos;t work out for whatever reason. No matter what, we want to ensure a smooth
                    process, so this section details how to take down everything in the most convenient way possible.
                </p>
            </LandingPanel>
        </LandingPage>
    );
